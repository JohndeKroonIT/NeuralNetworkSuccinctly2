...
namespace NeuralNetworks2
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            Console.WriteLine("Predict liberal (-1) or conservative (1) from age, incom");
            //create perceptron program 
            ...
            double alpha = 0.001;
            int maxEpochs = 100;
            Console.WriteLine("\nSetting learn rate to " + alpha.ToString("F3") + "and maxEpochs to " + maxEpochs);
            Console.WriteLine("\nBegin training");
        ...
        private static void ShowData(double[][] trainData)
        {
